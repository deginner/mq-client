...
class AsyncMQPublisher(AsyncMQClient):
    ...
    def __init__(self, amqp_url, producer, **kwargs):
        """
        ...
        """
        super(AsyncMQPublisher, self).__init__(amqp_url=amqp_url, **kwargs)
...
class AsyncMQConsumer(AsyncMQClient):
    ...
    def __init__(self, amqp_url, on_message, **kwargs):
        """
        Setup the publisher object, passing in the URL we will use
        to connect to RabbitMQ, and other connection parameters.
        ...
        """
        super(AsyncMQConsumer, self).__init__(amqp_url=amqp_url, **kwargs)
